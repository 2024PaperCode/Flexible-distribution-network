...
for i = 1 : T
    ...
    i
    its = [its; bestFitVal]
    writematrix(value(its), 'C:\Users\Qiu\Desktop\OPFdata11\its_case33bw0.xlsx');
end
...
function [FitVal, bestFitVal] = updateFitVal(popSize, remapX, X,FitVal, bestFitVal)
    for i = 1 : popSize
        ...
        if bestFitVal > ret
            Xbest = X(i,:);
            bestFitVal = ret;
            writematrix(value(W1), 'C:\Users\Qiu\Desktop\OPFdata11\W1_case33bw0.xlsx');
            writematrix(value(alpha1), 'C:\Users\Qiu\Desktop\OPFdata11\alpha1_case33bw0.xlsx');
            writematrix(value(P1), 'C:\Users\Qiu\Desktop\OPFdata11\P1_case33bw0.xlsx'); 
            writematrix(value(Q1), 'C:\Users\Qiu\Desktop\OPFdata11\Q1_case33bw0.xlsx');  
            writematrix(value(Vk1), 'C:\Users\Qiu\Desktop\OPFdata11\Vmk1_case33bw0.xlsx'); 
            writematrix(value(Plm1), 'C:\Users\Qiu\Desktop\OPFdata11\Plm1_case33bw0.xlsx');
            writematrix(value(Qlm1), 'C:\Users\Qiu\Desktop\OPFdata11\Qlm1_case33bw0.xlsx');

            writematrix(value(W2), 'C:\Users\Qiu\Desktop\OPFdata11\W2_case33bw0.xlsx');
            writematrix(value(alpha2), 'C:\Users\Qiu\Desktop\OPFdata11\alpha2_case33bw0.xlsx');
            writematrix(value(P2), 'C:\Users\Qiu\Desktop\OPFdata11\P2_case33bw0.xlsx');
            writematrix(value(Q2), 'C:\Users\Qiu\Desktop\OPFdata11\Q2_case33bw0.xlsx');  
            writematrix(value(Vk2), 'C:\Users\Qiu\Desktop\OPFdata11\Vmk2_case33bw0.xlsx'); 
            writematrix(value(Plm2), 'C:\Users\Qiu\Desktop\OPFdata11\Plm2_case33bw0.xlsx');
            writematrix(value(Qlm2), 'C:\Users\Qiu\Desktop\OPFdata11\Qlm2_case33bw0.xlsx');

            writematrix(value(Pso), 'C:\Users\Qiu\Desktop\OPFdata11\Pso_case33bw0.xlsx'); 
            writematrix(value(Qso), 'C:\Users\Qiu\Desktop\OPFdata11\Qso_case33bw0.xlsx'); 
            writematrix(value(ftc), 'C:\Users\Qiu\Desktop\OPFdata11\SOP_case33bw0.xlsx');
            writematrix(value(cost), 'C:\Users\Qiu\Desktop\OPFdata11\cost_case33bw0.xlsx');
            writematrix([nsop], 'C:\Users\Qiu\Desktop\OPFdata11\nso_case33bw0.xlsx');
        end
    end
end
...
function [nsop,fr,to,Cso] = pre_work(X)
    ...
    for i = 1 : 5
        if X(i) == 1
            ...
            Cso(o) = GetNum(X, 6+(i-1)*(6+6+15)+6+6, 6+(i-1)*(6+6+15)+6+6+14, [6,5,2,1,1])*0.001;
            m = m+1;
            n = n+1;
            o = o + 1;
        end
...
function [W1, P1, Q1,Plm1, Qlm1, Vk1, alpha1, W2, P2, Q2,Plm2, Qlm2,Vk2, alpha2,Pso,Qso, ret , ftc, cost, nsop] = myOPF(X)
    ...
    nv = 1;
    busPv = [4];
    Pv = [0.74, 0].*0; % pvmax   pvmin   有名值MV
    Pvcost = [0,18.5,0];
    [nsop,fr,to,Cso] = pre_work(X);
